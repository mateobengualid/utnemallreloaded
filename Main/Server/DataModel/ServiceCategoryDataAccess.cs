...
namespace UtnEmall.Server.DataModel
{
	...
	/// <summary>
	/// El <c>ServiceCategoryDataAccess</c> es una clase
	...
	public class ServiceCategoryDataAccess
	{
		...
		/// <summary>
		/// Función que carga todos los ServiceCategoryEntity desde la base de datos
		/// </summary>
		/// <param name="loadRelation">Si es true carga la relacion</param>
		...
		/// Si <paramref name="propertyName"/> no es una propiedad de la clase ServiceCategoryEntity.
		...
		/// <summary>
		/// Función que carga una lista de ServiceCategoryEntity desde la base de datos por idService.
		/// </summary>
		/// <param name="idService">Foreing key</param>
		...
		/// <summary>
		/// Función para cargar una lista de ServiceCategoryEntity desde la base de datos por idService.
		/// </summary>
		/// <param name="idService">columna Foreing key</param>
		/// <returns>IList de ServiceCategoryEntity</returns>
		...
		/// <summary>
		/// Función que carga una lista de ServiceCategoryEntity desde la base de datos por idCategory.
		/// </summary>
		...
		/// <summary>
		/// Función para cargar una lista de ServiceCategoryEntity desde la base de datos por idCategory.
		/// </summary>
