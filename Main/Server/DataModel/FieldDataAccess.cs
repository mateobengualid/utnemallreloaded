...
namespace UtnEmall.Server.DataModel
{
	...
	/// <summary>
	/// El <c>FieldDataAccess</c> es una clase
	...
	public class FieldDataAccess
	{
		...
		/// <summary>
		/// Función para cargar un FieldEntity desde la base de datos.
		/// </summary>
		...
		/// <summary>
		/// Función que guarda un FieldEntity en la base de datos.
		/// </summary>
		/// <param name="field">FieldEntity a guardar</param>
		/// <exception cref="ArgumentNullException">
		/// Si <paramref name="field"/> no es un <c>FieldEntity</c>.
		/// </exception>
		/// <exception cref="UtnEmallDataAccessException">
		/// Si una DbException ocurre cuando se accede a la base de datos
		/// </exception>
		...
		/// <summary>
		/// Función que elimina un FieldEntity de la base de datos.
		/// </summary>
		/// <param name="field">FieldEntity a eliminar</param>
		/// <exception cref="ArgumentNullException">
		/// Si <paramref name="field"/> no es un <c>FieldEntity</c>.
		/// </exception>
		/// <exception cref="UtnEmallDataAccessException">
		...
		/// <summary>
		/// Función que carga todos los FieldEntity desde la base de datos
		/// </summary>
		/// <param name="loadRelation">Si es true carga la relacion</param>
		...
		/// Si <paramref name="propertyName"/> no es una propiedad de la clase FieldEntity.
		...
		/// <summary>
		/// Función que carga una lista de FieldEntity desde la base de datos por idTable.
		/// </summary>
		...
		/// <summary>
		/// Función para cargar una lista de FieldEntity desde la base de datos por idTable.
		/// </summary>
		/// <param name="idTable">columna Foreing key</param>
		/// <returns>IList de FieldEntity</returns>
