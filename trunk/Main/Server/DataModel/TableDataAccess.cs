...
namespace UtnEmall.Server.DataModel
{
	...
	/// <summary>
	/// The <c>TableDataAccess</c> is a class
	...
	public class TableDataAccess
	{
		...
		/// <summary>
		/// Function to load a TableEntity from database.
		/// </summary>
		...
		/// <summary>
		/// Function to Save a TableEntity in the database.
		/// </summary>
		/// <param name="table">TableEntity to save</param>
		...
		/// <summary>
		/// Function to Load all the TableEntity from database.
		/// </summary>
		/// <param name="loadRelation">If is true load the relation</param>
		...
		/// If <paramref name="propertyName"/> is not a property of TableEntity class.
		...
		/// <summary>
		/// Function to Load the relation Fields from database.
		/// </summary>
		/// <param name="table">TableEntity parent</param>
		...
		/// <summary>
		/// Function to Load a list of TableEntity from database by idDataModel.
		/// </summary>
		...
		/// </summary>
		/// <param name="idDataModel">Foreing key column</param>
		/// <returns>IList of TableEntity</returns>
		...
		/// <summary>
		/// Function to Update a TableEntity from database.
		/// </summary>
		/// <param name="table">TableEntity to update</param>
		/// <exception cref="ArgumentNullException">
		/// if <paramref name="table"/> is not a <c>TableEntity</c>.
		/// </exception>
		/// <exception cref="UtnEmallDataAccessException">
